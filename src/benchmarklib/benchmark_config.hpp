...
class BenchmarkConfig {
 public:
  BenchmarkConfig(const BenchmarkMode init_benchmark_mode, const ChunkOffset init_chunk_size,
                  ...
                  const bool init_table_indexes, const int64_t init_max_runs, const int64_t init_max_warmup_runs, const Duration& init_max_duration,
